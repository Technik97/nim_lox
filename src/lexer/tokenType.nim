type TokenType* = enum 
    ...
    TT_COMMA, TT_DOT, TT_MINUS, TT_PLUS, TT_SEMICOLON, TT_SLASH,
    TT_STAR,
    ...
    # Keywords.
    TT_AND, TT_CLASS, TT_ELSE, TT_FALSE, TT_FUN, TT_FOR, 
    TT_IF, TT_NIL, TT_OR, TT_PRINT, TT_RETURN, TT_SUPER, TT_THIS, TT_TRUE, 
    TT_VAR, TT_WHILE,
